...
gpio_a = ["3.3V","5V","GPIO2","5V","GPIO3","Gnd","GPIO4","GPIO14","Gnd","GPIO15","GPIO17","GPIO18","GPIO27i","Gnd","GPIO22","GPIO23","3.3V","GPIO24i","GPIO10","Gnd","GPIO9","GPIO25i","GPIO11","GPIO8","Gnd","GPIO7","GPIO0","GPIO1","GPIO5","Gnd","GPIO6","GPIO12","GPIO13","Gnd","GPIO19","GPIO16","GPIO26i","GPIO20","Gnd","GPIO21"]
gpio_b = ["3.3V","5V","GPIO2","5V","GPIO3","Gnd","GPIO4","GPIO14nc","Gnd","GPIO15nc","GPIO17nc","GPIO18nc","GPIO27nc","Gnd","GPIO22nc","GPIO23nc","3.3V","GPIO24nc","GPIO10","Gnd","GPIO9","GPIO25nc","GPIO11i","GPIO8","Gnd","GPIO7","GPIO0","GPIO1","GPIO5","Gnd","GPIO6","GPIO12i","GPIO13i","Gnd","GPIO19nc","GPIO16nc","GPIO26nc","GPIO20nc","Gnd","GPIO21nc"]
gpio_c = ["3.3V","5V","GPIO2","5V","GPIO3","Gnd","GPIO4","GPIO14","Gnd","GPIO15","GPIO17","GPIO18","GPIO27i","Gnd","GPIO22","GPIO23","3.3V","GPIO24i","GPIO10","Gnd","GPIO9","GPIO25i","JTAG-TDI","GPIO8","Gnd","JTAG-TCK","JTAG-TMS","JTAG-TDO","GPIO5","Gnd","GPIO6","GPIO12","GPIO13","Gnd","GPIO19","GPIO16","GPIO26i","GPIO20","Gnd","GPIO21"]
