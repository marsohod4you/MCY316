...
Микропроцессор RISCV портированный на нашу плату MCY316.
Оригинал проекта вот здесь:  https://github.com/YosysHQ/picorv32

В оригинальном проекте очень хорошее описание на английском языке (оно кстати есть ниже).

Дополнительно можно почитать, как этот же проект работал на предыдущей нашей плате MCY112 https://marsohod.org/projects/mcy112-prj/428-picorv32-mcy112

Для платы MCY316 проект находится в папке picosoc-altera
